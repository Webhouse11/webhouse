      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 1 }}
            className="bg-white px-4 py-2 rounded-2xl shadow-xl border border-black/5 text-sm font-medium text-black flex items-center gap-2"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={handleClick}
            className="w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl flex items-center justify-center relative group overflow-hidden"
