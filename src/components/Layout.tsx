...
export const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'DFY Services', path: '/dfy-services' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              ...
              <li><Link to="/dfy-services" className="hover:text-emerald-400 transition-colors">DFY Services</Link></li>
              <li><Link to="/social-plus" className="hover:text-emerald-400 transition-colors">Social Plus</Link></li>
