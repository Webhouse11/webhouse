    ...
    <div className="pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-black/70">
          ...
          <p>
            PostPilot services are provided on a monthly subscription basis. By selecting a plan (Starter, Growth, or Premium), you agree to recurring billing. Payments are processed in advance each month. You may cancel or upgrade your plan with 30 days' notice. No refunds are provided for partial months of service.
          </p>
          ...
          <p>
            To perform our services (SMM, ads management), we may require access to your social media accounts. We promise to maintain the highest level of security and confidentiality regarding your login credentials and will only use them for the purposes of performing our agreed-upon services.
          </p>
          ...
          <h2 className="text-2xl font-bold text-black mt-10 mb-4">8. Governing Law</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-black mt-10 mb-4">9. Contact Information</h2>
          <p>
            If you have any questions about these Terms, please contact us at <strong>webhousemediastudio@gmail.com</strong>.
          </p>
        </div>
      </div>
    </div>
